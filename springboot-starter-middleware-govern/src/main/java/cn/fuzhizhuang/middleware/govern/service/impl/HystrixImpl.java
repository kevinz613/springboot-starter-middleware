 ...
 * @description 封装熔断保护
 */
public class HystrixImpl extends HystrixCommand<Object> implements IValveService {
     ...
     */
    public HystrixImpl(int timeout) {
        super(
                //设置命令属于哪一个组
    ...
    public Object access(ProceedingJoinPoint joinPoint, Method method, Object annotation, Object[] args) throws Throwable {
        ...
        UseHystrix useHystrix = (UseHystrix) annotation;
        //获取参数信息
    ...
    public boolean match(Object annotation) {
        return annotation instanceof UseHystrix;
    }
}
